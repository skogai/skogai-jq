---
name: h-implement-schema-validation
...
- Create schema-validation/transform.jq with jq transformation logic
- Create schema-validation/schema.json (input/args/output schemas)
- Create schema-validation/test-input.json and test-expected.json
- Add test cases to test.sh
- Follow crud-get/crud-set structure exactly

## Success Criteria

- [ ] schema-validation/transform.jq created with proper jq logic
- [ ] schema-validation/schema.json created with input/args/output schemas
- [ ] schema-validation/test-input.json and test-expected.json created
