...
- Create array-unique/transform.jq with jq transformation logic
- Create array-unique/schema.json (input/args/output schemas)
- Create array-unique/test-input.json and test-expected.json
- Add test cases to test.sh
- Follow crud-get/crud-set structure exactly

## Success Criteria

- [ ] array-unique/transform.jq created with proper jq logic
- [ ] array-unique/schema.json created with input/args/output schemas
- [ ] array-unique/test-input.json and test-expected.json created
