...
- Create has-field/transform.jq with jq transformation logic
- Create has-field/schema.json (input/args/output schemas)
- Create has-field/test-input.json and test-expected.json
- Add test cases to test.sh
- Follow crud-get/crud-set structure exactly

## Success Criteria

- [ ] has-field/transform.jq created with proper jq logic
- [ ] has-field/schema.json created with input/args/output schemas
- [ ] has-field/test-input.json and test-expected.json created
