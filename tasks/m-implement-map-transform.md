---
name: m-implement-map-transform
...
- Create map-transform/transform.jq with jq transformation logic
- Create map-transform/schema.json (input/args/output schemas)
- Create map-transform/test-input.json and test-expected.json
- Add test cases to test.sh
- Follow crud-get/crud-set structure exactly

## Success Criteria

- [ ] map-transform/transform.jq created with proper jq logic
- [ ] map-transform/schema.json created with input/args/output schemas
- [ ] map-transform/test-input.json and test-expected.json created
